...
Graph presentation resolves Design Core through the repository's current
...
The fixed banner state places Explorer left, Global Graph in the main area,
and Local Graph right. The separate Overview image uses the focused Global
Graph story so the body adds a materially different full-screen view.
