...
| LN-SLIDES-018 | Both Slides Autodocs families MUST use the repository's shared full-workspace Docs contract: a padding-free canvas containing an isolated 700-pixel-high story iframe. They MUST show copyable public plugin setup and non-empty component and story descriptions under LP-SPEC-045 and LP-SPEC-046. |
