...
The fixed banner state uses that populated diagnostics shell with both
sidebars closed. The plugin omits Overview media because its available
full-screen state would repeat the banner.
