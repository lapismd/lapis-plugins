...
| ID | Requirement |
| --- | --- |
| LN-SRC-001 | The repository MUST publish `@lapis-notes/source-editor` from `packages/source-editor` at independent version `0.1.0` while preserving runtime ID `lapis-source-editor`. |
