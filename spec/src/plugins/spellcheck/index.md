...
The fixed banner state uses the populated Problems shell with both sidebars
closed. The separate Overview image uses the editor action-popover story so it
adds a materially different full-screen state.
